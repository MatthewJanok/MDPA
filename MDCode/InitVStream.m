...
T = 30;
T1 = 50;%added to script

AddCircAtomicArray(5, 0, -1e-8, 0, 0, 0, T1, 2)
AddRectAtomicArray(10, 10, 0, 0, 0, 0, 0, T, 0);
% vy0 = -sqrt(0.02*Ep/Mass1);
% AddRectAtomicArray(4,4,0,12*AtomSpacing,0,vy0,0,T,1);
Ep = 2;
AddParticleStream(10, 0.1, 10, -pi / 2, 1, Ep * C.q_0, 5);

Size = 10*AtomSpacing;
Limits = [-3*Size +3*Size -3*Size +3*Size]; % square is good
PlDelt = 5 * dt;
